...
const WindowTooSmall: Component = () => {
  ...
  return (
    <>
      <div class="txt1 ml-[0px] mt-[0px] absolute opacity-0">
        <div class="eczar-thin text-5xl">
          <p>screen should be bigger than 940 to view content.</p>
        </div>
      </div>
